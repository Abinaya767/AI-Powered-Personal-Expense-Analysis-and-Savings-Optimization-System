...
DIFY_API_URL = "YOUR_DIFY_ENDPOINT_HERE"
...
if generate_report:
    ...
    if DIFY_API_URL == "https://api.dify.ai/v1":
        st.error("❌ Please configure your Dify API endpoint.")
        st.stop()
...
# Convert daily expenses into monthly expenses
...
if food_monthly > 0 or transport_monthly > 0:
